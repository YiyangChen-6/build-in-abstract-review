...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |mt2-p3-starter (11)|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
(require 2htdp/image)

(@assignment exams/2021w1-mt2/mt2-p3)

(@cwl ychen808)   ;fill in your CWL here (same CWL you put for 110 problem sets)
...
(define (steps lo hi odd-color even-color)
  (local [(define (tex n)
          ...
          (define (combine i rnr)
            (beside/align "bottom" rnr i))]
    (foldr combine empty-image (build-list (+ 1 (- hi lo)) block))))
